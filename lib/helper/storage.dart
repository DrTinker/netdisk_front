// ignore_for_file: curly_braces_in_flow_control_structures, prefer_conditional_assignment, unnecessary_null_comparison
...
class SyncStorage {
  /// 静态私有实例对象
  static final _instance=SyncStorage._init();
  /// 工厂构造函数 返回实例对象
